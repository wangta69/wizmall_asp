...
Response.Redirect("./wizboard/board_delete.asp?bid="&bid&"&gid="&gid&"&adminmode="&adminmode&"&uid="&uid&"&page="&page&"&search_category="&search_category&"&search_word="&search_word)
Response.End()
ElseIf user_id <> "" Then
'' 현재 비밀번호와 책크
End if
