    ...
    <td> 
      ...
      <table width="100%" height="90" border="0" cellpadding="0" cellspacing="1" bgcolor="D7D7D7">
        <tr> 
          <td bgcolor="#F3F3F3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr valign="bottom"> 
                ...
                <td width="20" align="left"><img src="<%=skin_path%>images/bar_1.gif" width="2" height="15"></td>
                <td width="150" align="left">date : <%=FormatDateTime(v_regdate,2)%>,<!-- homepage : <%=v_homepage%>,--> hit 
                  : <%=v_count%></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
          <td bgcolor="#F3F3F3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr valign="bottom"> 
                <td width="76" align="center" class="font1">휴대전화</td>
                <td width="20" align="left"><img src="<%=skin_path%>images/bar_1.gif" width="2" height="15"></td>
                <td align="left"><%=v_sub_subject2%></td>
        ...
        <tr> 
          <td bgcolor="#F3F3F3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr valign="bottom"> 
                <td width="76" align="center" class="font1">신청내용</td>
                <td width="20" align="left"><img src="<%=skin_path%>images/bar_1.gif" width="2" height="15"></td>
                <td align="left"><%=v_sub_subject1%></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
