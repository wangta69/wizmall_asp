  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="left" bgcolor="#F9F9F9" style="padding-left:5"><input name="subject" type="text" id="subject" style="BACKGROUND-COLOR: #FFFFFF; BORDER: #DDDDDD 1 solid; font-family:Tahoma; font-size:11px; color:#5E5E5E; HEIGHT: 18px; width:99%" value="<%=w_subject%>">
          </td>
        </tr>
        <tr>
          <td height="1" colspan="2"bgcolor="#DDDDDD"></td>
