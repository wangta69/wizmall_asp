...
%>
            ...
            <tr>
              <td height="180" colspan="7" align="center">
			  <textarea name="content" id="board_content" cols="95" rows="12" class="required" msg="내용을 입력해 주세요"><%=w_content%></textarea>
			  </td>
<% if sethtmleditor = 1 then %>
<script>
var oEditors = [];
...
<% end if %> 
            ...
            <tr>
              ...
              <td width="1" align="center" valign="middle" bgcolor="f0f0f0"><img src="<%=skin_path%>images/dotline.gif" width="1" height="25"></td>
              <td colspan="5" align="left">&nbsp;&nbsp;
                <input name="attached" type="file" id="attached" maxlength="80">
