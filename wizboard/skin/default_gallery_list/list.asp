        ...
        <tr> 
          <td bgcolor="F3F3F3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr valign="bottom"> 
                ...
                <td width="60" align="center" class="font1">이미지</td>
                <td width="2"><img src="<%=skin_path%>images/bar_1.gif" width="2" height="15"></td>
...
%>	  
        <tr> 
          <td height="26" colspan="11" align="center" >등록된글이없습니다</td>
        </tr>
        <tr bgcolor="E6E6E6"> 
          <td height="1" colspan="11"></td>
        </tr>
...
if ListFile1 <> "" then
	ListImg = "<img src='" & util.getAttachedIcon(ListFile1, attached_dir, "default") & "' width='60' height='60' border='0'>"
...
%>		
        <tr> 
          <td height="26" colspan="11" align="center"><table width="100%" height="26"  border="0" cellpadding="0" cellspacing="1" bgcolor="D7D7D7">
              <tr> 
