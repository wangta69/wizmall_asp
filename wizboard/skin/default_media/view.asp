...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="100" height="26" align="center" bgcolor="#efefef" class="ft1"><img src="/admin/kor_board/images/file.gif" width="16" height="12"></td>
...
%>	</td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td valign="top" style="padding-left:15; padding-right:15; padding-top:12; padding-bottom:15"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="text">
				<%
for i = 0 to ubound(filenameArr) 			  
