	...
	<tr>
		<td>
			...
			<table border="0" width="100%" cellspacing="1" cellpadding="0" bordercolor="#ffffff" bordercolorlight="#000000">
				<tr  height=30>
        <td width="14%" bgcolor="#9BC05C" align="center"><font color="#ff4500">일(日)</font></td>
	...
	for intLoopWeek=1 to 6   '주단위 루프 시작, 최대 6주 
		...
		for intLoopDay=1 to 7  '요일단위 루프 시작, 일요일부터
			...
			if intFirstWeekDay > 1 then  '첫주시작일이 1보다 크면
				Response.Write "<font face=굴림 size=2 color=white>.</font>"&vbCR
				...
				if intPrintDay > intLastDay then '입력날짜가 월말보다 크다면
					...
					if intThisYear-NowThisYear=0 and intThisMonth-NowThisMonth=0 and intPrintDay-intThisDay=0 then '오늘 날짜이면은 글씨폰트를 다르게
						...
						Response.Write "<font size=2><b><a href=schedule_main.asp?d=d&F_Year="&intThisYear&"&F_Month="&intThisMonth&"&F_Day="&IntPrintDay&" ><b>"&intPrintDay&"</b></font></a></b> <a href=schedule_main.asp?d=d&F_Year="&intThisYear&"&F_Month="&intThisMonth&"&F_Day="&IntPrintDay & "&m=input&sdate="&intThisYear&"-"&intThisMonth&"-"&intPrintDay&"&shour=9><img src= ../../images/add.gif border=0 alt=일정추가></a><br>"&vbCR
					
					
					elseif  intLoopDay=1 then '일요일이면 빨간 색으로
						Response.Write "<a href=schedule_main.asp?d=d&F_Year="&intThisYear&"&F_Month="&intThisMonth&"&F_Day="&IntPrintDay&" ><font color=ff4500>"&intPrintDay&"</font></a> <a href=schedule_main.asp?d=d&F_Year="&intThisYear&"&F_Month="&intThisMonth&"&F_Day="&IntPrintDay & "&m=input&sdate="&intThisYear&"-"&intThisMonth&"-"&intPrintDay&"&shour=9><img src= ../../images/add.gif border=0 alt=일정추가></a><br>"&vbCR
					else ' 그외의 경우
						Response.Write "<font face=굴림 size=2 color=#000000><a href=schedule_main.asp?d=d&F_Year="&intThisYear&"&F_Month="&intThisMonth&"&F_Day="&IntPrintDay&" >"&intPrintDay&"</a></font> <a href=schedule_main.asp?d=d&F_Year="&intThisYear&"&F_Month="&intThisMonth&"&F_Day="&IntPrintDay & "&m=input&sdate="&intThisYear&"-"&intThisMonth&"-"&intPrintDay&"&shour=9><img src= ../../images/add.gif border=0 alt=일정추가></a><br>"&vbCR
					end if
...
'삽입시작				
					...
					If  not objRs.eof  Then
						...
						Do while not objRs.eof 
							...
							Response.Write  "<font face=굴림><span style='font-size:9pt'><a href=schedule_main.asp?d="&d&"&m=view&cid="&cc_id&" onMouseOver=""view('"&cc_title&"', '"&lhour&"','"&cc_desc&"');""  onMouseOut=""noview();"" >"&cc_title&"</a></span></font><br>"&vbCR	
							rsobjRs.MoveNext
						Loop
					Else
						response.write "<font face=굴림><span style='font-size:9pt'></span></font>"&vbCR
					End if
					rsobjRs.close
					set objRs=nothing
					'/////////////////////////////////////////////  시간단위 일정등록 쿼리 종료 ////////////////////////////////////////////
...
<table width="630" border="0">
  <tr>          
    <td width="32%" align="right">
      <a href="Schedule_main.asp?d=m&F_Year=<%=intPrevYear%>&F_Month=<%=intPrevMonth%>&F_Day=<%=intPrevDay%>"> 
      <img src="../../images/icon01_02_pre.gif" width="58" height="19" border=0></a>
    </td>
    <td width="13%" valign="middle"><font size="2">
      <a href="Schedule_main.asp?d=m&F_Year=<%=intPrevYear%>&F_Month=<%=intPrevMonth%>&F_Day=<%=intPrevDay%>">[ <%=intPrevMonth%>월 달]</a></font></td>
    <td width="10%" valign="middle"></td>
    <td width="13%" valign="middle"><font size="2">
      <a href="Schedule_main.asp?d=m&F_Year=<%=intNextYear%>&F_Month=<%=intNextMonth%>&F_Day=<%=intNextDay%>">
      [ <%=intNextMonth%>월 달]</a></font></td>
