<%
Dim intThisYear,intThisMonth,intThisDay, datToday, NowThisYear, NowThisMonth, NowThisDay
Dim intPrevYear, intPrevMonth, intNextYear, intNextMonth
...
If intThisDay	= "" then intThisDay	= NowThisDay ''현재 날짜를 일 변수에
...
Dim intLastDay,intPrevLastDay,intNextLastDay,datFirstDay,intFirstWeekday,datThisDay,intThisWeekday
...
datThisDay		= cdate(intThisYear&"-"&intThisMonth&"-1") ''해당 년-월-일의 날짜변환          
End If
