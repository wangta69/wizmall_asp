  ...
  <tr> 
    <td valign="top" colspan="4"> 
      ...
      <table width="100%" border="1" cellspacing="2" cellpadding="0">
        <tr>
          <td width="15%" bgcolor="#C0DFAC" valign="middle" align="center"><font size="2">11월5일(일)</font></td>
          <td width="85%" height="50" bgcolor="#D2E8C4">&nbsp;</td>
        </tr>
        <tr>
          <td width="15%" bgcolor="#E8E8BB" valign="middle" align="center"><font size="2">11월6일(월)</font></td>
          <td width="85%" height="50" bgcolor="#EFEFCF">&nbsp;</td>
        </tr>
        <tr>
          <td width="15%" bgcolor="#C0DFAC" valign="middle" align="center"><font size="2">11월7일(화)</font></td>
          <td width="85%" height="50" bgcolor="#D2E8C4">&nbsp;</td>
        </tr>
        <tr>
          <td width="15%" bgcolor="#E8E8BB" valign="middle" align="center"><font size="2">11월8일(수)</font></td>
          <td width="85%" height="50" bgcolor="#EFEFCF">&nbsp;</td>
        </tr>
        <tr>
          <td width="15%" bgcolor="#C0DFAC" valign="middle" align="center"><font size="2">11월9일(목)</font></td>
          <td width="85%" height="50" bgcolor="#D2E8C4">&nbsp;</td>
        </tr>
        <tr>
          <td width="15%" bgcolor="#E8E8BB" valign="middle" align="center"><font size="2">11월10일(금)</font></td>
          <td width="85%" height="50" bgcolor="#EFEFCF">&nbsp;</td>
        </tr>
        <tr>
          <td width="15%" bgcolor="#C0DFAC" valign="middle" align="center"><font size="2">11월11일(토)</font></td>
          <td width="85%" height="50" bgcolor="#D2E8C4">&nbsp;</td>
        </tr>
      </table>
          ...
          <td height="80"> 
            <table width="150" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666">
              <tr bgcolor="#006633" bordercolor="#006633"> 
                <td height="22"> 
                  <div align="center"><font size="2"> <font color="#FFFFFF"><b>11월줄 
                    일정</b></font></font></div>
                </td>
              </tr>
              <tr> 
