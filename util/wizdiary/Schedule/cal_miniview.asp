...
<table border=0 width=140 bgcolor=#E8F0E1>
    ...
    <font color="#000000"><%=intThisYear%>년 <%=intThisMonth%>월 <%=intThisDay%>일</font>
    </tr></td>
	<tr>
		<td align=left valign="top">
			<a href=schedule_main.asp?d=m&F_Year=<%=intPrevYear&"&F_Month="&intPrevMonth&"&F_Day=1"%>><font color=navy >&lt;&lt;</font></a>
		</td>
		<td align=right>
			<a href=schedule_main.asp?d=m&F_Year=<%=intNextYear&"&F_Month="&intNextMonth&"&F_Day=1"%>><font color=navy >&gt;&gt;</font></a>
		</td>
	</tr>
</table>
...
intPrintDay=1
			...
			if intFirstWeekDay > 1 then '첫주시작일이 1보다 크면
				...
				if intPrintDay > intLastDay then '입력날짜가 월말보다 크다면
					...
					if intThisYear-NowThisYear=0 and intThisMonth-NowThisMonth=0 and intPrintDay-intThisDay=0 then '오늘 날짜이면은 글씨폰트를 다르게
						Response.Write "<td  bgcolor=#E8F0E1 align=right valign=top><b><a href=schedule_main.asp?d=d&F_Year="&intThisYear&"&F_Month="&intThisMonth&"&F_Day="&intPrintDay&" ><font color=000000>"&intPrintDay&"</font></a></b><br>"&vbCR
					elseif  intLoopDay=1 then '일요일이면 빨간 색으로
						Response.Write "<td bgcolor=#E8F0E1  align=right valign=top><a href=schedule_main.asp?d=d&F_Year="&intThisYear&"&F_Month="&intThisMonth&"&F_Day="&intPrintDay&" ><font color=ff4500>"&intPrintDay&"</font></a><br>"&vbCR
					else ' 그외의 경우
						Response.Write "<td bgcolor=#E8F0E1  align=right valign=top><font color=#000000><a href=schedule_main.asp?d=d&F_Year="&intThisYear&"&F_Month="&intThisMonth&"&F_Day="&intPrintDay&" >"&intPrintDay&"</a></font><br>"&vbCR
					end if
				end if										
	...
	next
	Set rslink=Nothing
		%><form method="POST" action="schedule_main.asp" id=form1 name=cal>
	<tr>
		<td colspan=7 align=center bgcolor=#E8F0E1 height="25" valign="bottom">
			<font color=white> 
				<div align="center">
					...
					<select name=F_Month size=1  onchange="window.open('schedule_main.asp?d=m&F_Day=1&F_Month='+document.cal.F_Month.value+'&F_Year='+document.cal.F_Year.value,'_self')" >
					<%
					for i=1 to 12
