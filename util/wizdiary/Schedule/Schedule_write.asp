      ...
      <table width="100%" border="1">
        <tr> 
          <td width="57" height="25" bgcolor="#B4CE82"> 
            <div align="center"><font size="2" color="#FFFFFF"><b>제목</b></font></div>
          </td>
        ...
        <tr> 
          <td width="57" height="25" bgcolor="#B4CE82"> 
            <div align="center"><font size="2" color="#FFFFFF"><b>장소</b></font></div>
          </td>
        ...
        <tr> 
          <td width="57" height="25" bgcolor="#B4CE82"> 
            <div align="center"><font size="2" color="#FFFFFF"><b>일정성격</b></font></div>
          </td>
          <td height="25" bgcolor="#DBECC8" colspan="4"> 
            <select name="select2">
              <option>회의</option>
        ...
        <tr> 
          <td width="57" height="25" bgcolor="#B4CE82"> 
            <div align="center"><font size="2" color="#FFFFFF"><b>시간구분</b></font></div>
          </td>
        ...
        <tr> 
          <td width="57" height="25" bgcolor="#B4CE82"> 
            <div align="center"><font size="2" color="#FFFFFF"><b>일자</b></font></div>
          </td>
          <td height="25" bgcolor="#DBECC8" colspan="4"> 
            <select name="select4">
              <option>2000년</option>
        ...
        <tr> 
          <td width="57" height="25" bgcolor="#B6BA1B"> 
            <div align="center"><font size="2" color="#FFFFFF"><b>시작시간</b></font></div>
          </td>
          ...
          <td height="25" bgcolor="#EFEFCF" colspan="2"><font size="2" color="#339933">▶<font color="#000000">기간 
            <select name="select9">
              <option>1</option>
            </select>
            시간 
        ...
        <tr> 
          <td width="57" height="28" bgcolor="#B6BA1B"> 
            <div align="center"><font size="2" color="#FFFFFF"><b>종료시간</b></font></div>
          </td>
        ...
        <tr> 
          <td width="57" height="25" bgcolor="#B6BA1B"> 
            <div align="center"><font size="2" color="#FFFFFF"><b>내용</b></font></div>
          </td>
        ...
        <tr> 
          <td rowspan="2" height="25" bgcolor="#B6BA1B" width="57"> 
            <div align="center"><font size="2" color="#FFFFFF"><b>반복옵션</b></font></div>
          </td>
        ...
        <tr> 
          <td height="80"> 
            <table width="150" border="1" cellpadding="0" cellspacing="0" bordercolor="#006633">
              <tr bgcolor="#006633"> 
                <td height="22"> 
                  <div align="center"><font size="2"> <b><font color="#FFFFFF">11월줄 
                    일정</font></b></font></div>
                </td>
              </tr>
              <tr> 
