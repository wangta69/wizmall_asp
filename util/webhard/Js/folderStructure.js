...
{ 
  ...
  if (level>0) 
    ...
    { 
      ...
      leftSide = leftSide + "<img src='./image/ftv2vertline.gif' width=16 height=22>" 
      this.isLastNode = 0 
    } 
  else 
    this.renderOb("") 
...
{ 
  ...
  doc.write(leftSide) 
  this.outputLink() 
  doc.write("<img id='folderIcon" + this.id + "' name='folderIcon" + this.id + "' src='./image/" + this.iconSrc+"' border=0></a>") 
...
{  
  ...
  if (level>0) 
    ...
    { 
      this.renderOb(leftSide + "<img src='./image/ftv2lastnode.gif' width=16 height=22>") 
      leftSide = leftSide + "<img src='./image/ftv2blank.gif' width=16 height=22>"  
    } 
    else 
    { 
      this.renderOb(leftSide + "<img src='./image/ftv2node.gif' width=16 height=22>") 
      leftSide = leftSide + "<img src='./image/ftv2vertline.gif' width=16 height=22>" 
    } 
  else 
    this.renderOb("")   
...
{ 
  ...
  doc.write("src='./image/s"+this.iconSrc+"' border=0>") 
  doc.write("</a>") 
  doc.write("</td><td valign=middle nowrap>") 
  if (USETEXTLINKS) 
...
{ 
  ...
  if (browserVersion == 0) 
	doc.write("<p class=er>Use to javascript</p>")
} 
