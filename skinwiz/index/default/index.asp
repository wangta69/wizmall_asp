...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td background="./skinwiz/index/<%=MainSkin %>/images/mainimg_bg.jpg"><%=util.getBanner("maintop", 719, 179)%></td>
  </tr>
</table>
...
%>
          <td width="144" align="center"><table width="134" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="134" height="42" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td align="center"><strong><font color="C28299"><%=price%>원</font></strong> </td>
              </tr>
            </table></td>
          <%
cnt = cnt + 1
