...
<!-- 공통 parameter 설정 시작 -->
    ...
    <input type="hidden" name="MxID" value="<%=CARD_ID%>"> <!-- 가맹점 ID -->
    ...
    <input type="hidden" name="DBPATH" value="./dbpath.asp"> <!-- 결과 저장 파일 경로 -->
    <input type="hidden" name="REDIRPATH" value="./redirpath.asp"> <!-- 결과 화면 파일 경로 -->
...
<!-- 휴대폰결제 parameter 설정 시작 -->
    ...
    <input type="hidden" name="ItemInfo" value="1|<%=Amount%>|1|12S0Hz0000|<%=CARD_ID%>"> <!-- 종류|금액|1|상품코드|가맹점 -->
