...
<!--
$(function(){
	$(".left_menu1").hover(function(i){
		$(".left_menu2").hide();
		$(".left_menu2").eq($(".left_menu1").index(this)).show(); //메서드
	}, 
	function(){
		$(".left_menu2").hide();
	}
...
'' 대분류 리스트
	Response.Write "<tr class='left_menu1'><td width='167' height='25' background='./skinwiz/layout/"&LayoutSkin&"/images/product_cat_bg.gif' style='text-align:left'><img src='./skinwiz/layout/"&LayoutSkin&"/images/product_cat_icon.gif' width='19' height='7' align='absmiddle'><A HREF='./wizmart.asp?code="&cat_no&"'>" & cat_name&"</a><FONT COLOR='GRAY'>"&FMENU_NUM&"</FONT>"
						  
'' 중분류 카테고리를 리스트 한다.
		
			Response.Write "<DIV class='left_menu2' style='display:none;margin-left:120px;margin-top:-20px;background-color:#FFFFFF;position:absolute;z-index:2000'><TABLE border=0 VALIGN=TOP cellpadding=0 cellspacing=1  WIDTH=140>"&Chr(13)&Chr(10)
			...
			objRs1.MOVENEXT
			WEND
			Response.Write "</table></DIV>"&Chr(13)&Chr(10)
