...
dim arrData(4,3), curSize, curPer, curSeason, curCount
dim dataLength
dim addSize
...
sub Manage()
	...
	'계절별 카운터
	strSQL = "select vSeason,count(vNum) from "&theTable&sqlValue&" group by vSeason order by vSeason"
	Set objRs	= db.ExecSQLReturnRS(strSQL, Nothing, DbConnect)
	...
	for i = 0 to rowsCount - 1
		...
		arrData(curSeason,0) = curCount
		arrData(curSeason,1) = curSize
		arrData(curSeason,2) = curPer
...
<form action="./main.asp" method="post" name="Form1">
        ...
        <input type="hidden" name="theme" value="visit/visit_season">
        <table class="table_main w_default">
          <tr> 
            <td align="left"> <select name="YY" onChange="document.Form1.submit();">
              ...
              [<a href="./main.asp?menushow=<%=menushow%>&theme=visit/visit_season">전체</a>&nbsp;|&nbsp;<a href="./main.asp?menushow=<%=menushow%>&theme=visit/visit_season&YY=<%=year(date)%>">올해</a>] 
          ...
          <tr> 
            <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="0" background="image_visit/background1.gif">
                ...
                <tr onMouseOver="rbar(this);" onMouseOut="cbar(this);" height="40">	
                  <td width="43" align="center"><%=curSeason%>&nbsp;</td>
