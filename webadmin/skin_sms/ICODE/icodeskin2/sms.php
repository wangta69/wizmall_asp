		...
		<td height="55" valign="top"><table width="100%" height="10" border="0" cellpadding="0" cellspacing="0" background="./sms_images/bg3.gif">
				<tr> 
					...
					<td width="139" align="center" bgcolor="9BE5FF"><table width="80%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="center"><input type="text" name="MSG_TXT_CNT" size="2" style="background-color:#B3F1FF; border-color:#000000; border:solid 0; height: 14px; width: 18px; FONT-SIZE: 9pt;" maxlength="2" value="0" readonly> / 70 Byte</td>
							</tr>
						</table> </td>
