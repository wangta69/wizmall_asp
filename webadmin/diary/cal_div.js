...
txt = '<table width=250 cellpadding=2 cellspacing=1 border=0 bgcolor=black><tr><td bgcolor=#DBECC8 align="center"><font size=2 face=돋움>' + title + '</td></tr><tr><td bgcolor=white><table width=100% cellpadding=2 cellspacing=0 border=0><tr><td align=right><font size=1 face=Arial color=ff7f50>' + stime + '</td></tr><tr><td><font size=2 face=돋움 color=#333333>' + content + '</td></tr></table></td></tr></table>';
//	if ((a != "") && (b == "")) {
